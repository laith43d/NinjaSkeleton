...
import rest_auth.models.email_account
import uuid
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated', models.DateTimeField(auto_now=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='rest_auth.passwordlessaccount')),
            ],
            options={
                'ordering': ['-created'],
            },
        ...
        migrations.CreateModel(
            ...
            managers=[
                ('objects', rest_auth.models.email_account.EmailAccountManager()),
            ],
        ),
    ]
